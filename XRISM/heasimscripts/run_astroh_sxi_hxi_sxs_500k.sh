...
outfile=output/astroH_cxb_sxi.fits
...
arffile=$arf
intbackfile=none
psbackfile=pscat_cxb_sxi.txt
difbackfile=difcat_cxb_sxi.txt
pszbackfile=pszcat_cxb_sxi.txt
...
outfile=output/astroH_cxb_hxi1.fits
...
intbackfile=none
mdbfile=$LHEA_DATA/heasim.mdb
psbackfile=pscat_cxb_hxi.txt
difbackfile=difcat_cxb_hxi.txt
pszbackfile=pszcat_cxb_hxi.txt
mdbfile=$mdbfile 
...
outfile=output/astroH_cxb_hxi2.fits
...
outfile=output/astroH_cxb_sxs.fits
