...
#arf="$resp_dir/resolve_flt_spec_noGV_20190611.arf"
arf="$resp_dir/resolve_bet_spec_withGV_20190611.arf"
#arf ="$resp_dir/resolve_flt_spec_noGV_20190611.arf"
#rmf="$resp_dir/resolve_h7ev_2019a.rmf"
rmf="$resp_dir/resolve_h5ev_2019a.rmf"
#outfile=output/astroH_sxi_plaw.fits                            

sourcefile="M87.dat"
outfile="output/M87_GV_150ks.fits"
logfile="output/M87_GV_150ks.log"
