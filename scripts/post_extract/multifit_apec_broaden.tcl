...
#set file [open "XRISM_regionN_list.txt" r]

#set file [open "XRISMshift_list.txt" r]
#set file [open "XRISMshift1_list.txt" r]
set data [read $file]
close $file
set data [split $data]
...
#cpd XRISMspecfits1_proj.ps/ps
cpd XRISMshift_broad_proj.ps/ps
#cpd XRISMshift1_broad_proj.ps/ps
#cpd XRISMspecfits1_broad_proj.ps/ps
