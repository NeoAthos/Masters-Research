...
cpd XRISMspecfits1_broad_1T_proj.ps/ps
...
#ignore **:**-0.5,7.0 ;1.05,1.2
   ...
   # @~/scripts/fit_10.tcl
    ...
    chatter 10
    error 2.706 1 2 3 4 5 6 7 8;# Calculates the 2.706-sigma confidence or the 90% confidence range
...
#    puts $outfile "Z_lerr [expr 0.]"
    ...
    editmod phabs*cflux(bapec+powerlaw) & /*
    newpar 2 0.1
    newpar 3 100.0
    newpar 4 -12.0
#newpar 4 -13.0
