...
# fout=open(path+cluster_name+"_projected_properties.csv",'w')
fout=open(path+cluster_name+"_projected_properties_new.csv",'w')
# pdf0=many_pdf.PdfPages(path+cluster_name+'_plot_projected_properties.pdf')
pdf0=many_pdf.PdfPages(path+cluster_name+'_plot_projected_properties_new.pdf')
...
print(np.genfromtxt(path+"specfits.csv",unpack = True))
rin,rout,nh0,nh_p0,nh_n0,kt0,kt_p0,kt_n0,Z0,Z_p0,Z_n0,n0,n_p0,n_n0,stats0,logflux0,logflux_p0,logflux_n0,chi,dof,rechi = np.genfromtxt(path+"specfits_region.csv",unpack = True)
#rin,rout,nh0,nh_p0,nh_n0,kt0,kt_p0,kt_n0,Z0,Z_p0,Z_n0,n0,n_p0,n_n0,stats0,logflux0,logflux_p0,logflux_n0,chi,dof,rechi = np.genfromtxt(path+"specfits_proj_new.csv",unpack = True)
