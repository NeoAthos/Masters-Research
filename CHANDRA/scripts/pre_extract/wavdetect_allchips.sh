...
echo $evt2name
# summedimage=$(ls ../evt2_bgsub_*_*.fits)
#summedimage=$(ls ../evt2_bgsub_500_7000.fits)
...
wavdetect infile=${summedimage} outfile=wav_out.fits scellfile=wav_scell.fits imagefile=wav_image.fits defnbkgfile=wav_defnbkg.fits regfile=allsources.reg psffile=${psfmap} sigthresh= 1e-10 bkgsigthresh=0.001 ellsigma=5 scales="2.0 4.0" clobber=yes
