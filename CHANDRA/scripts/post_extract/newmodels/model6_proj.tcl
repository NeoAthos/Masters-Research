...
cpd specfits_model6_proj_tlo0p1.ps/ps
...
#ignore **:**-0.5,7.0 ;
   ...
   # @~/scripts/fit_10.tcl
    ...
    error 1. 2 3 6;#Calculates the 1-sigma confidence range or the 68.3% confidence range
    ...
    # Print out results
    set outfile [open "${base}_model6_fit_out_tlo0p1.txt" w]
